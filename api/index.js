...
//     const token = await jwt.sign({ _id: "" }, "456465fgchchchycfc64564654654654hchgcfcgcgfcg")


//     const userverify = await jwt.verify(token, "456465fgchchchycfc64564654654654hchgcfcgcgfcg")
// }
...
app.post("/signin", async (req, res, next) => {
    try {
        ...
        if (person == null) {
            ...
            // const verifyuser = jwt.verify(tokens, "456465fgchchchycfc64564654654654hchgcfcgcgfcg")

            // const user = await Car.findOne({ _id: verifyuser._id })
            // res.json(user)
